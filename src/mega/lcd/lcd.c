...
void lcdClearlines(bool from) {
    setBuff(gu8LCDBuffer + (from << 4), 0x20, LCD_NUMBER_OF_BYTE);
}
...
/*
 ...
 |                                 < updateProgressBar >                                                   |
 --------------------------------------------------------------------------------------------------------
 | < @Function          : void updateProgressBar                                                           |
 | < @Description       : LCD update Progress Bat                                                   |                                           
 | < @return            : void                                                                          |                                                             
 --------------------------------------------------------------------------------------------------------
 */
void lcdupdateProgressBar(uint8_t count, uint8_t totalCount, uint8_t lineToPrintOn) {
    float factor;
    uint8_t percent;
    uint8_t number;
    uint8_t remainder;
