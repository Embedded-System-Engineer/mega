...
#error TIMER 0 not defined
    ...
    if ((TIFR & _BV(TOV0)) && (t > (0xFF))) { /*the overflow at max value*/
        currentInterruptTick++;
        t = 0;
    }
...
/*
 ...
 ----------------------------------------------------------------------------------------------------------------------------
 */
void __delay_ms(millis_t ms) {
    millis_t current;
    current = systemMillis();
    while (systemMillis() < current + ms);
}
...
/*
 ...
 ----------------------------------------------------------------------------------------------------------------------------
 */
void __delay_us(micros_t us) {
    micros_t current;
    current = systemMicros();
    while (systemMicros() < current + us);
}